    ...
    return (
        <div className="">
            <Link to="https://bit.ly/vanshmahajan">
                <div  className=" group left-6 top-[135px] rounded-xl flex items-center justify-between absolute h-[50px] w-[50px] hover:w-[150px] hover:bg-[var(--main-color)] border-2">
